...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(9431843341183961)
,p_name=>'FORMAT_MASK'
...
wwv_flow_imp_page.create_ig_report_column(
 p_id=>wwv_flow_imp.id(9437497414184272)
,p_view_id=>wwv_flow_imp.id(15629403024226179)
,p_display_seq=>9
,p_column_id=>wwv_flow_imp.id(9431843341183961)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_imp_page.create_ig_report_column(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6052192604368761)
...
'                    format_mask     VARCHAR(100) PATH ''$.format_mask''',
'                 )',
'             )',
'    ) LOOP',
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(6052522260368764)
,p_event_id=>wwv_flow_imp.id(23162890681001706)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(6052290904368762)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(6052344161368763)
,p_event_id=>wwv_flow_imp.id(6052290904368762)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
