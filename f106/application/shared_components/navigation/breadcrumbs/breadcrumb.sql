...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(9409432213025270)
,p_short_name=>'Add New Template v2'
,p_long_name=>'Add New Template v2'
,p_link=>'f?p=&APP_ID.:1002:&SESSION.::&DEBUG.:::'
,p_page_id=>1002
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(9409908126030963)
,p_short_name=>'Load Data v2'
,p_long_name=>'Load Data v2'
