prompt --application/shared_components/logic/application_processes/ajx_manage_report_view
begin
--   Manifest
...
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(13074446782408611)
,p_process_sequence=>1
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'AJX_MANAGE_REPORT_VIEW'
