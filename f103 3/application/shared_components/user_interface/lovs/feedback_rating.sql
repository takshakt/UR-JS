...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(8712962833923184)
,p_lov_name=>'FEEDBACK_RATING'
,p_lov_query=>'.'||wwv_flow_imp.id(8712962833923184)||'.'
,p_location=>'STATIC'
,p_version_scn=>45069603847186
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(8713253855923184)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(8713698507923186)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(8714060894923187)
