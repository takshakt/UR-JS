...
wwv_flow_imp_page.create_page(
 p_id=>1006
,p_name=>'Report Template'
,p_alias=>'REPORT-TEMPLATE'
,p_step_title=>'Report Template'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'OFF'
,p_javascript_file_urls=>'#APP_FILES#DynamicReportJS#MIN#.js'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9903517614138614)
,p_plug_name=>'staticCntRN'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15881362790763205)
,p_plug_name=>'Report Template'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(32227819366536255)
,p_name=>'P1006_ALERT_MESSAGE'
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(12818862061870685)
,p_name=>'New'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1006_FILE_LOAD'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(12819349365870686)
,p_event_id=>wwv_flow_imp.id(12818862061870685)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(12819716282870687)
,p_name=>'New_1'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1006_TEMPLATE_LOV'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(12820230797870689)
,p_event_id=>wwv_flow_imp.id(12819716282870687)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(12820603273870690)
,p_name=>'Page_Load_DA'
,p_event_sequence=>50
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(12818459982870683)
,p_name=>'Change_Hotel'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1006_HOTEL_LIST'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(12817591563870679)
,p_name=>'New_3'
,p_event_sequence=>90
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(12818097980870682)
,p_event_id=>wwv_flow_imp.id(12817591563870679)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(12821016863870691)
,p_name=>'Changed'
,p_event_sequence=>100
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1006_ALERT_MESSAGE'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(12821534582870693)
,p_event_id=>wwv_flow_imp.id(12821016863870691)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(12817152489870677)
...
,p_internal_uid=>12817152489870677
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(12816755696870675)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>12816755696870675
);
