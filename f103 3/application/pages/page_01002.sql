...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(39256412915467734)
,p_plug_name=>'Report'
,p_title=>'Details'
,p_parent_plug_id=>wwv_flow_imp.id(39505643003042024)
...
' WHERE NAME = :P1002_FILE_LOAD',
'UNION ALL',
'SELECT ''File Name'', FILENAME FROM APEX_APPLICATION_TEMP_FILES WHERE NAME = :P1002_FILE_LOAD',
'UNION ALL',
'SELECT ''Records'', to_char(records-1) FROM temp_blob WHERE NAME = :P1002_FILE_LOAD*/',
'SELECT ''ID'' AS attribute, TO_CHAR(f.id) AS value',
'FROM apex_application_temp_files f',
'WHERE f.name = :P1002_FILE_LOAD',
'',
'UNION ALL',
'',
...
,p_ajax_items_to_submit=>'P1002_FILE_LOAD'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(39256483598467735)
...
,p_owner=>'VKANT'
,p_internal_uid=>39256483598467735
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(39507254381042040)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(39507356704042041)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(39457513257883888)
...
,p_affected_region_id=>wwv_flow_imp.id(39505643003042024)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(30226710464500763)
,p_event_id=>wwv_flow_imp.id(30225210896500758)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(39256412915467734)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
...
'  VALUES (v_key, :P1002_TEMPLATE_NAME, :P0_HOTEL_ID, :P1002_TEMPLATE_TYPE, ''Y'', v_sanitized_json);',
'  COMMIT;',
'',
...
,p_attribute_03=>'P1002_ALERT_TITLE,P1002_ALERT_MESSAGE,P1002_ALERT_TIMER,P0_ALERT_MESSAGE'
,p_attribute_04=>'N'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
