...
'    if (!table) return console.error("Table not found");',
'',
unistr('    // \2705 Extract headers and rows directly from HTML'),
'    const rows = table.querySelectorAll("tr");',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(13491368351956401)
,p_plug_name=>'Dynamic_Report_DetailsRN'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(13490419006952044)
,p_plug_name=>'Breadcrumb'
,p_title=>'Hotel Dashboard'
