...
,p_group_id=>wwv_flow_imp.id(8769138960923584)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8770628148923590)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8771072162923593)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8770308325923589)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8771585310923595)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8771072162923593)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8771853203923596)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8772379816923598)
,p_event_id=>wwv_flow_imp.id(8771853203923596)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8772851023923600)
,p_event_id=>wwv_flow_imp.id(8771853203923596)
