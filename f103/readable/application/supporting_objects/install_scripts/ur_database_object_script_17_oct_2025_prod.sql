  ...
  CREATE TABLE "UR_16_OCT_CP_14_D1_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"C14_DAYS_ROOMS_COMMIT" NUMBER, 
	"C14_DAYS_ADR_COMMIT" NUMBER, 
	"C7DAYS_REV" NUMBER, 
	"C14_DAYS_GROUPS" NUMBER, 
	"CREATED_BY" RAW(16), 
	"UPDATED_BY" RAW(16), 
	"CREATED_ON" DATE, 
	"UPDATED_ON" DATE, 
	...
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_16_OCT_CP_14_D1_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_16_OCT_CP_14_D2_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_16_OCT_CP_14_D2_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "UR_16_OCT_CP_14_D2_T_STAY_DATE_UQ" UNIQUE ("STAY_DATE")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_16_OCT_CP_28_D1_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"C28_DAYS_ROOMS_COMMIT" NUMBER, 
	"C28_DAYS_ADR_COMMIT" NUMBER, 
	"C14_DAYS_REV" NUMBER, 
	"CREATED_BY" RAW(16), 
	"UPDATED_BY" RAW(16), 
	"CREATED_ON" DATE, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_16_OCT_CP_28_D1_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "UR_16_OCT_CP_28_D1_T_STAY_DATE_UQ" UNIQUE ("STAY_DATE")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_16_OCT_CP_28_D2_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"TODAY_ROOMS_COMMIT" NUMBER, 
	"TODAY_ADR_COMMIT" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_16_OCT_CP_28_D2_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_16_OCT_CP_7_D1_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_16_OCT_CP_7_D1_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_16_OCT_CP_LOS1_1_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"DOW" VARCHAR2(4000), 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_16_OCT_CP_LOS1_1_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "UR_16_OCT_CP_LOS1_1_T_STAY_DATE_UQ" UNIQUE ("STAY_DATE")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_16_OCT_CP_LOS1_2_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"C7_DAYS_CHANGES" NUMBER, 
	"DELTA_HOTELS_BY_MARRIOTT_YORK" NUMBER, 
	"HILTON_YORK" NUMBER, 
	"HOLIDAY_INN_YORK_AN_IHG_HOTEL" NUMBER, 
	"RADISSON_HOTEL_YORK" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_16_OCT_CP_LOS1_2_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "UR_16_OCT_CP_LOS1_2_T_STAY_DATE_UQ" UNIQUE ("STAY_DATE")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_16_OCT_CP_LOS_1_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"DOW" VARCHAR2(4000), 
	"LOS3" NUMBER, 
	...
	"VOCO_BELFAST_AN_IHG_HOTEL" NUMBER, 
	"HILTON_YORK2" NUMBER, 
	"HOLIDAY_INN_YORK_AN_IHG_HOTEL2" NUMBER, 
	"RADISSON_HOTEL_YORK2" NUMBER, 
	"THE_MILNER_YORK_FORMERLY_THE_PRINCIPAL_YORK2" NUMBER, 
	"NOVOTEL_YORK_CENTRE2" NUMBER, 
	"DOUBLETREE_BY_HILTON_YORK2" NUMBER, 
	"MOXY_YORK2" NUMBER, 
	"HOTEL_INDIGO_YORK_AN_IHG_HOTEL2" NUMBER, 
	"HAMPTON_BY_HILTON_YORK2" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_16_OCT_CP_LOS_1_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;
  ...
  CREATE TABLE "UR_APS1_T" 
   (	"REC_ID" RAW(16), 
	"BOOKING_DATE" DATE, 
	"NUM_PEOPLE" NUMBER, 
	"COST" NUMBER, 
	"PACKAGE_DEAL" VARCHAR2(4000), 
	"DIRECT" VARCHAR2(4000), 
	"PCW" VARCHAR2(4000), 
	"REPEAT_BOOKER" VARCHAR2(4000), 
	"BOOKER_NAME" VARCHAR2(4000), 
	"BOOKER_REF" VARCHAR2(4000), 
	"CREATED_BY" RAW(16), 
	"UPDATED_BY" RAW(16), 
	"CREATED_ON" DATE, 
	"UPDATED_ON" DATE, 
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_APS1_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "UR_APS1_T_BOOKING_DATE_UQ" UNIQUE ("BOOKING_DATE")
  USING INDEX  ENABLE
   ) ;
  ...
  CREATE TABLE "UR_CHG_CROWBOROUGH_ARMS_BETA_T" 
   (	"REC_ID" RAW(16), 
	"BOOKING_DATE" DATE, 
	"NUM_PEOPLE" NUMBER, 
	"COST" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_CHG_CROWBOROUGH_ARMS_BETA_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "UR_CHG_CROWBOROUGH_ARMS_BETA_T_BOOKING_DATE_UQ" UNIQUE ("BOOKING_DATE")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_CHG_CROWBOROUGH_ARMS_T" 
   (	"REC_ID" RAW(16), 
	"BOOKING_DATE" DATE, 
	"NUM_PEOPLE" NUMBER, 
	"COST" VARCHAR2(4000), 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_CHG_CROWBOROUGH_ARMS_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;
  ...
  CREATE TABLE "UR_TEST_16_OCT_CP_T" 
   (	"REC_ID" RAW(16), 
	"BOOKING_DATE" DATE, 
	"NUM_PEOPLE" NUMBER, 
	"COST" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_TEST_16_OCT_CP_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;
  ...
  CREATE TABLE "UR_TEST_CP_15_10_1_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"TODAY_ROOMS_COMMIT" NUMBER, 
	"TODAY_ADR_COMMIT" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_TEST_CP_15_10_1_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "UR_TEST_CP_15_10_1_T_STAY_DATE2_UQ" UNIQUE ("STAY_DATE2")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_TEST_CP_15_10_T" 
   (	"REC_ID" RAW(16), 
	"BOOKING_DATE" DATE, 
	"NUM_PEOPLE" NUMBER, 
	"COST" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_TEST_CP_15_10_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;
  ...
  CREATE TABLE "UR_TEST_TEMPLATE_1_CP_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"YESTERDAY_ROOMS_COMMIT" NUMBER, 
	"YESTERDAY_ADR_COMMIT" VARCHAR2(4000), 
	"YESTERDAY_REV" VARCHAR2(4000), 
	"YESTERDAY_GROUPS_RNTS" NUMBER, 
	"CREATED_BY" RAW(16), 
	"UPDATED_BY" RAW(16), 
	"CREATED_ON" DATE, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_TEST_TEMPLATE_1_CP_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "UR_TEST_TEMPLATE_1_CP_T_STAY_DATE_UQ" UNIQUE ("STAY_DATE")
  USING INDEX  ENABLE
   ) ;
  ...
  CREATE TABLE "UR_TMPLT_NEW_CP_17_OCT_1_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"TODAY_ROOMS_COMMIT" NUMBER, 
	"TODAY_ADR_COMMIT" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_TMPLT_NEW_CP_17_OCT_1_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "UR_TMPLT_NEW_CP_17_OCT_1_T_STAY_DATE_UQ" UNIQUE ("STAY_DATE")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_TMPLT_NEW_CP_17_OCT_2_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"TODAY_ROOMS_COMMIT" NUMBER, 
	"TODAY_ADR_COMMIT" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_TMPLT_NEW_CP_17_OCT_2_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "UR_TMPLT_NEW_CP_17_OCT_2_T_STAY_DATE_UQ" UNIQUE ("STAY_DATE")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_TMPLT_NEW_CP_17_OCT_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"DOW" VARCHAR2(4000), 
	"MY_OTB_PERCENT" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_TMPLT_NEW_CP_17_OCT_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "UR_TMPLT_NEW_CP_17_OCT_T_STAY_DATE_UQ" UNIQUE ("STAY_DATE")
  USING INDEX  ENABLE
   ) ;
  ...
  CREATE TABLE "UR_UR_19_POINT_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"GPAGEID" VARCHAR2(4000), 
	"REC_TYPE" VARCHAR2(4000), 
	"REC_TYPE_DESC" VARCHAR2(4000), 
	"SUMNO_ROOMSPERREC_TYPE" NUMBER, 
	"SUMCALC_OCCROOMSPERREC_TYPE" NUMBER, 
	"SUMCALC_INVROOMSPERREC_TYPE" NUMBER, 
	"SUMARRIVAL_ROOMSPERREC_TYPE" NUMBER, 
	"SUMCOMPLIMENTARY_ROOMSPERREC_T" NUMBER, 
	"SUMHOUSE_USE_ROOMSPERREC_TYPE" NUMBER, 
	"SUMDAY_USE_ROOMSPERREC_TYPE" NUMBER, 
	"SUMNO_SHOW_ROOMSPERREC_TYPE" NUMBER, 
	"SUMIND_DEDUCT_ROOMSPERREC_TYPE" NUMBER, 
	"SUMIND_NON_DEDUCT_ROOMSPERREC" NUMBER, 
	"SUMGRP_DEDUCT_ROOMSPERREC_TYPE" NUMBER, 
	"SUMGRP_NON_DEDUCT_ROOMSPERREC" NUMBER, 
	"SUMDEPARTURE_ROOMSPERREC_TYPE" NUMBER, 
	"SUMOOO_ROOMSPERREC_TYPE" NUMBER, 
	"SUMNO_PERSONSPERREC_TYPE" NUMBER, 
	"SUMINVENTORY_ROOMSPERREC_TYPE" NUMBER, 
	"SUMREVENUEPERREC_TYPE" NUMBER, 
	"SUMOWNER_ROOMSPERREC_TYPE" NUMBER, 
	"SUMFF_ROOMSPERREC_TYPE" NUMBER, 
	"CF_AVERAGE_ROOM_RATE_REC_TYPE" NUMBER, 
	"CF_OCCUPANCY_REC_TYPE" NUMBER, 
	"REVENUE" NUMBER, 
	"NO_ROOMS" NUMBER, 
	"IND_DEDUCT_ROOMS" NUMBER, 
	"IND_NON_DEDUCT_ROOMS" NUMBER, 
	"GRP_DEDUCT_ROOMS" NUMBER, 
	"GRP_NON_DEDUCT_ROOMS" NUMBER, 
	"NO_PERSONS" NUMBER, 
	...
	"IND_DEDUCT_REVENUE" NUMBER, 
	"IND_NON_DEDUCT_REVENUE" NUMBER, 
	"GRP_NON_DEDUCT_REVENUE" NUMBER, 
	"GRP_DEDUCT_REVENUE" NUMBER, 
	"OWNER_ROOMS" NUMBER, 
	"FF_ROOMS" NUMBER, 
	"CF_OOO_ROOMS" NUMBER, 
	"CF_CALC_OCC_ROOMS" NUMBER, 
	"CF_CALC_INV_ROOMS" NUMBER, 
	"CF_AVERAGE_ROOM_RATE" NUMBER, 
	"CF_OCCUPANCY" NUMBER, 
	"CF_IND_DED_REV" NUMBER, 
	"CF_IND_NON_DED_REV" VARCHAR2(4000), 
	"CF_BLK_DED_REV" NUMBER, 
	"CF_BLK_NON_DED_REV" VARCHAR2(4000), 
	"CREATED_BY" RAW(16), 
	"UPDATED_BY" RAW(16), 
	"CREATED_ON" DATE, 
	"UPDATED_ON" DATE, 
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_UR_19_POINT_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;
  ...
  CREATE TABLE "UR_UR_EVENTS_UP_T" 
   (	"REC_ID" RAW(16), 
	"DATE" DATE, 
	"EVENT" VARCHAR2(4000), 
	"CREATED_BY" RAW(16), 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_UR_EVENTS_UP_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_UR_OY_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"ARRIVAL_DATE" DATE, 
	"ARRIVAL_DAY" VARCHAR2(4000), 
	"WE_INDICATOR" VARCHAR2(4000), 
	"CAPACITY" VARCHAR2(4000), 
	"DAYS_OUT" VARCHAR2(4000), 
	"SYS_REM_DEM" NUMBER, 
	"REM_DEM_STLY" NUMBER, 
	"APPLIED_REM_DEM" NUMBER, 
	"USER_OVERRIDE" VARCHAR2(4000), 
	"EVENT" VARCHAR2(4000), 
	"OYV2_TOTAL_HOTEL_OCCUPANCY" NUMBER, 
	"TOTAL_AVAILABLE_TRANSIENT_SUPPLY" NUMBER, 
	"TOTAL_TRANSIENT_BOOKED" NUMBER, 
	"TOTAL_TRANSIENT_BOOKED_STLY" NUMBER, 
	"ADDITIONAL_DEMAND" NUMBER, 
	"ADDITIONAL_DEMAND_STLY" NUMBER, 
	"TOTAL_TRANSIENT_DEMAND" NUMBER, 
	"TOTAL_TRANSIENT_DEMAND_STLY" NUMBER, 
	"ALLOTMENT_FORECAST" VARCHAR2(4000), 
	"ALLOTMENT_ROOMS_SOLD" VARCHAR2(4000), 
	"OUT_OF_ORDER" NUMBER, 
	"GROUP_ROOM_BLOCK_AUTHORIZED" NUMBER, 
	"GROUP_BOOKED" NUMBER, 
	"OYV2_GROUP_PROJ" NUMBER, 
	"CONTRACT_ROOM_BLOCK_AUTHORIZED" NUMBER, 
	"CONTRACT_BOOKED" NUMBER, 
	"OYV2_CONTRACT_PROJ" NUMBER, 
	"COMPLIMENTARY_BOOKED_TY" NUMBER, 
	"REM_DEM_PREMIUM_RETAIL_TY_HASH" NUMBER, 
	"REM_DEM_PREMIUM_RETAIL_TY_PERCENT" NUMBER, 
	"PREMIUM_RETAIL_TY" NUMBER, 
	"REM_DEM_PREMIUM_RETAIL_STLY_HASH" VARCHAR2(4000), 
	"REM_DEM_PREMIUM_RETAIL_STLY_PERCENT" VARCHAR2(4000), 
	"PREMIUM_RETAIL_STLY" NUMBER, 
	"REM_DEM_STANDARD_RETAIL_TY_HASH" NUMBER, 
	"REM_DEM_STANDARD_RETAIL_TY_PERCENT" NUMBER, 
	"STANDARD_RETAIL_TY" NUMBER, 
	"REM_DEM_STANDARD_RETAIL_STLY_HASH" VARCHAR2(4000), 
	"REM_DEM_STANDARD_RETAIL_STLY_PERCENT" VARCHAR2(4000), 
	"STANDARD_RETAIL_STLY" NUMBER, 
	"REM_DEM_SPECIAL_CORPORATE_LRA_TY_HASH" NUMBER, 
	"REM_DEM_SPECIAL_CORPORATE_LRA_TY_PERCENT" NUMBER, 
	"SPECIAL_CORPORATE_LRA_TY" NUMBER, 
	"REM_DEM_SPECIAL_CORPORATE_LRA_STLY_HASH" VARCHAR2(4000), 
	"REM_DEM_SPECIAL_CORPORATE_LRA_STLY_PERCENT" VARCHAR2(4000), 
	"SPECIAL_CORPORATE_LRA_STLY" NUMBER, 
	"REM_DEM_REWARD_REDEMPTION_TY_HASH" NUMBER, 
	"REM_DEM_REWARD_REDEMPTION_TY_PERCENT" NUMBER, 
	"REWARD_REDEMPTION_TY" NUMBER, 
	"REM_DEM_REWARD_REDEMPTION_STLY_HASH" VARCHAR2(4000), 
	"REM_DEM_REWARD_REDEMPTION_STLY_PERCENT" VARCHAR2(4000), 
	"REWARD_REDEMPTION_STLY" NUMBER, 
	"REM_DEM_POLICY_DRIVEN_TY_HASH" NUMBER, 
	"REM_DEM_POLICY_DRIVEN_TY_PERCENT" NUMBER, 
	"POLICY_DRIVEN_TY" NUMBER, 
	"REM_DEM_POLICY_DRIVEN_STLY_HASH" VARCHAR2(4000), 
	"REM_DEM_POLICY_DRIVEN_STLY_PERCENT" VARCHAR2(4000), 
	"POLICY_DRIVEN_STLY" NUMBER, 
	"REM_DEM_GOVT_MILITARY_TY_HASH" NUMBER, 
	"REM_DEM_GOVT_MILITARY_TY_PERCENT" NUMBER, 
	"GOVT_MILITARY_TY" NUMBER, 
	"REM_DEM_GOVT_MILITARY_STLY_HASH" VARCHAR2(4000), 
	"REM_DEM_GOVT_MILITARY_STLY_PERCENT" VARCHAR2(4000), 
	"GOVT_MILITARY_STLY" NUMBER, 
	"REM_DEM_RETAIL_TIED_DISCOUNT_TY_HASH" NUMBER, 
	"REM_DEM_RETAIL_TIED_DISCOUNT_TY_PERCENT" NUMBER, 
	"RETAIL_TIED_DISCOUNT_TY" NUMBER, 
	"REM_DEM_RETAIL_TIED_DISCOUNT_STLY_HASH" VARCHAR2(4000), 
	"REM_DEM_RETAIL_TIED_DISCOUNT_STLY_PERCENT" VARCHAR2(4000), 
	"RETAIL_TIED_DISCOUNT_STLY" NUMBER, 
	"REM_DEM_FIXED_DISCOUNT_TY_HASH" NUMBER, 
	"REM_DEM_FIXED_DISCOUNT_TY_PERCENT" NUMBER, 
	"FIXED_DISCOUNT_TY" NUMBER, 
	"REM_DEM_FIXED_DISCOUNT_STLY_HASH" VARCHAR2(4000), 
	"REM_DEM_FIXED_DISCOUNT_STLY_PERCENT" VARCHAR2(4000), 
	"FIXED_DISCOUNT_STLY" NUMBER, 
	"ROOM_COLLECTION_1_HURDLE_REVENUE" NUMBER, 
	"ROOM_COLLECTION_1_TRANSIENT_OTB_TY" NUMBER, 
	"ROOM_COLLECTION_1_TRANSIENT_OTB_STLY" NUMBER, 
	"ROOM_COLLECTION_1_REM_DEMTY_HASH" NUMBER, 
	"ROOM_COLLECTION_1_REM_DEM_TY_PERCENT" NUMBER, 
	"ROOM_COLLECTION_1_REM_DEM_STLY_HASH" NUMBER, 
	"ROOM_COLLECTION_1_REM_DEM_STLY_PERCENT" NUMBER, 
	"ROOM_COLLECTION_2_HURDLE_REVENUE" NUMBER, 
	"ROOM_COLLECTION_2_TRANSIENT_OTB_TY" NUMBER, 
	"ROOM_COLLECTION_2_TRANSIENT_OTB_STLY" NUMBER, 
	"ROOM_COLLECTION_2_REM_DEMTY_HASH" NUMBER, 
	"ROOM_COLLECTION_2_REM_DEM_TY_PERCENT" NUMBER, 
	"ROOM_COLLECTION_2_REM_DEM_STLY_HASH" NUMBER, 
	"ROOM_COLLECTION_2_REM_DEM_STLY_PERCENT" NUMBER, 
	"ROOM_COLLECTION_3_HURDLE_REVENUE" NUMBER, 
	"ROOM_COLLECTION_3_TRANSIENT_OTB_TY" NUMBER, 
	"ROOM_COLLECTION_3_TRANSIENT_OTB_STLY" NUMBER, 
	"ROOM_COLLECTION_3_REM_DEMTY_HASH" NUMBER, 
	"ROOM_COLLECTION_3_REM_DEM_TY_PERCENT" NUMBER, 
	"ROOM_COLLECTION_3_REM_DEM_STLY_HASH" NUMBER, 
	"ROOM_COLLECTION_3_REM_DEM_STLY_PERCENT" NUMBER, 
	"ROOM_COLLECTION_4_HURDLE_REVENUE" NUMBER, 
	"ROOM_COLLECTION_4_TRANSIENT_OTB_TY" NUMBER, 
	"ROOM_COLLECTION_4_TRANSIENT_OTB_STLY" NUMBER, 
	"ROOM_COLLECTION_4_REM_DEMTY_HASH" NUMBER, 
	"ROOM_COLLECTION_4_REM_DEM_TY_PERCENT" NUMBER, 
	"ROOM_COLLECTION_4_REM_DEM_STLY_HASH" NUMBER, 
	"ROOM_COLLECTION_4_REM_DEM_STLY_PERCENT" NUMBER, 
	"CREATED_BY" RAW(16), 
	"UPDATED_BY" RAW(16), 
	"CREATED_ON" DATE, 
	"UPDATED_ON" DATE, 
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_UR_OY_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_UR_STR_FOUR_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"THIS_YEAR_MY_PROP" NUMBER, 
	"COMP_SET" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_UR_STR_FOUR_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "UR_UR_STR_SEC_T" 
   (	"REC_ID" RAW(16), 
	"STAY_DATE" DATE, 
	"THIS_YEAR_MY_PROP" NUMBER, 
	"COMP_SET" NUMBER, 
	...
	"HOTEL_ID" RAW(16), 
	"INTERFACE_LOG_ID" RAW(16), 
	 CONSTRAINT "UR_UR_STR_SEC_T_PK" PRIMARY KEY ("REC_ID")
  USING INDEX  ENABLE
   ) ;
...
ALTER TRIGGER "UR_YORK_TEMP14_T_BI_TRG" ENABLE;
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_16_OCT_CP_14_D1_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_14_D1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_16_OCT_CP_14_D1_T_BI_TRG;

/
ALTER TRIGGER "UR_16_OCT_CP_14_D1_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_16_OCT_CP_14_D2_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_14_D2_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_16_OCT_CP_14_D2_T_BI_TRG;

/
ALTER TRIGGER "UR_16_OCT_CP_14_D2_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_16_OCT_CP_28_D1_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_28_D1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_16_OCT_CP_28_D1_T_BI_TRG;

/
ALTER TRIGGER "UR_16_OCT_CP_28_D1_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_16_OCT_CP_28_D2_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_28_D2_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_16_OCT_CP_28_D2_T_BI_TRG;

/
ALTER TRIGGER "UR_16_OCT_CP_28_D2_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_16_OCT_CP_7_D1_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_7_D1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_16_OCT_CP_7_D1_T_BI_TRG;

/
ALTER TRIGGER "UR_16_OCT_CP_7_D1_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_16_OCT_CP_LOS1_1_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_LOS1_1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_16_OCT_CP_LOS1_1_T_BI_TRG;

/
ALTER TRIGGER "UR_16_OCT_CP_LOS1_1_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_16_OCT_CP_LOS1_2_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_LOS1_2_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_16_OCT_CP_LOS1_2_T_BI_TRG;

/
ALTER TRIGGER "UR_16_OCT_CP_LOS1_2_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_16_OCT_CP_LOS_1_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_LOS_1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_16_OCT_CP_LOS_1_T_BI_TRG;

/
ALTER TRIGGER "UR_16_OCT_CP_LOS_1_T_BI_TRG" ENABLE;
...
ALTER TRIGGER "TRG_UR_ALGO_VERSIONS_BI_TRG" ENABLE;
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_APS1_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_APS1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_APS1_T_BI_TRG;

/
ALTER TRIGGER "UR_APS1_T_BI_TRG" ENABLE;
...
ALTER TRIGGER "UR_BHAUMIK_T_BI_TRG" ENABLE;
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_CHG_CROWBOROUGH_ARMS_BETA_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_CHG_CROWBOROUGH_ARMS_BETA_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_CHG_CROWBOROUGH_ARMS_BETA_T_BI_TRG;

/
ALTER TRIGGER "UR_CHG_CROWBOROUGH_ARMS_BETA_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_CHG_CROWBOROUGH_ARMS_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_CHG_CROWBOROUGH_ARMS_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_CHG_CROWBOROUGH_ARMS_T_BI_TRG;

/
ALTER TRIGGER "UR_CHG_CROWBOROUGH_ARMS_T_BI_TRG" ENABLE;
...
ALTER TRIGGER "UR_TEST_13_10_CP_T_BI_TRG" ENABLE;
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_TEST_16_OCT_CP_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_TEST_16_OCT_CP_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_TEST_16_OCT_CP_T_BI_TRG;

/
ALTER TRIGGER "UR_TEST_16_OCT_CP_T_BI_TRG" ENABLE;
...
ALTER TRIGGER "UR_TEST_CHINAR_T_BI_TRG" ENABLE;
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_TEST_CP_15_10_1_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_TEST_CP_15_10_1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_TEST_CP_15_10_1_T_BI_TRG;

/
ALTER TRIGGER "UR_TEST_CP_15_10_1_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_TEST_CP_15_10_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_TEST_CP_15_10_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_TEST_CP_15_10_T_BI_TRG;

/
ALTER TRIGGER "UR_TEST_CP_15_10_T_BI_TRG" ENABLE;
...
ALTER TRIGGER "UR_TEST_STACY_T_BI_TRG" ENABLE;
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_TEST_TEMPLATE_1_CP_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_TEST_TEMPLATE_1_CP_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_TEST_TEMPLATE_1_CP_T_BI_TRG;

/
ALTER TRIGGER "UR_TEST_TEMPLATE_1_CP_T_BI_TRG" ENABLE;
...
ALTER TRIGGER "UR_TEST_TEMPLATE_T_BI_TRG" ENABLE;
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_TMPLT_NEW_CP_17_OCT_1_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_TMPLT_NEW_CP_17_OCT_1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_TMPLT_NEW_CP_17_OCT_1_T_BI_TRG;

/
ALTER TRIGGER "UR_TMPLT_NEW_CP_17_OCT_1_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_TMPLT_NEW_CP_17_OCT_2_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_TMPLT_NEW_CP_17_OCT_2_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_TMPLT_NEW_CP_17_OCT_2_T_BI_TRG;

/
ALTER TRIGGER "UR_TMPLT_NEW_CP_17_OCT_2_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_TMPLT_NEW_CP_17_OCT_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_TMPLT_NEW_CP_17_OCT_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_TMPLT_NEW_CP_17_OCT_T_BI_TRG;

/
ALTER TRIGGER "UR_TMPLT_NEW_CP_17_OCT_T_BI_TRG" ENABLE;
...
ALTER TRIGGER "UR_TT_T_BI_TRG" ENABLE;
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_UR_19_POINT_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_UR_19_POINT_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_UR_19_POINT_T_BI_TRG;

/
ALTER TRIGGER "UR_UR_19_POINT_T_BI_TRG" ENABLE;
...
ALTER TRIGGER "UR_UR_CHINAR_QUAL_T_BI_TRG" ENABLE;
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_UR_EVENTS_UP_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_UR_EVENTS_UP_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_UR_EVENTS_UP_T_BI_TRG;

/
ALTER TRIGGER "UR_UR_EVENTS_UP_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_UR_OY_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_UR_OY_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_UR_OY_T_BI_TRG;

/
ALTER TRIGGER "UR_UR_OY_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_UR_STR_FOUR_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_UR_STR_FOUR_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_UR_STR_FOUR_T_BI_TRG;

/
ALTER TRIGGER "UR_UR_STR_FOUR_T_BI_TRG" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "UR_UR_STR_SEC_T_BI_TRG" 
BEFORE INSERT OR UPDATE ON "UR_UR_STR_SEC_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
BEGIN
  ...
  ELSIF UPDATING THEN
    ...
    :NEW.UPDATED_ON := SYSDATE;
  END IF;
END UR_UR_STR_SEC_T_BI_TRG;

/
ALTER TRIGGER "UR_UR_STR_SEC_T_BI_TRG" ENABLE;
...
ALTER TRIGGER "UR_VK_SEG1_T_BI_TRG" ENABLE;
  ...
  CREATE UNIQUE INDEX "UR_16_OCT_CP_7_D1_T_PK" ON "UR_16_OCT_CP_7_D1_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_TEST_TEMPLATE_1_CP_T_STAY_DATE_UQ" ON "UR_TEST_TEMPLATE_1_CP_T" ("STAY_DATE") 
  ;

  CREATE UNIQUE INDEX "UR_UR_19_POINT_T_PK" ON "UR_UR_19_POINT_T" ("REC_ID") 
  ;

  CREATE UNIQUE INDEX "UK_UR_ALGO_ATTRIBUTES_KEY" ON "UR_ALGO_ATTRIBUTES" ("KEY") 
  ;

  CREATE UNIQUE INDEX "UR_TEST_16_OCT_CP_T_PK" ON "UR_TEST_16_OCT_CP_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_APS1_T_PK" ON "UR_APS1_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_16_OCT_CP_LOS1_2_T_STAY_DATE_UQ" ON "UR_16_OCT_CP_LOS1_2_T" ("STAY_DATE") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_UR_STR_FOUR_T_PK" ON "UR_UR_STR_FOUR_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_TEST_TEMPLATE_1_CP_T_PK" ON "UR_TEST_TEMPLATE_1_CP_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_APS1_T_BOOKING_DATE_UQ" ON "UR_APS1_T" ("BOOKING_DATE") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_16_OCT_CP_LOS1_1_T_STAY_DATE_UQ" ON "UR_16_OCT_CP_LOS1_1_T" ("STAY_DATE") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_16_OCT_CP_28_D1_T_PK" ON "UR_16_OCT_CP_28_D1_T" ("REC_ID") 
  ;

  CREATE UNIQUE INDEX "UR_TEMP_NN_T_STAY_DATE_UQ" ON "UR_TEMP_NN_T" ("STAY_DATE") 
  ;

  CREATE UNIQUE INDEX "UR_16_OCT_CP_28_D2_T_PK" ON "UR_16_OCT_CP_28_D2_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_16_OCT_CP_LOS_1_T_PK" ON "UR_16_OCT_CP_LOS_1_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_UR_STR_SEC_T_PK" ON "UR_UR_STR_SEC_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_TEST_CP_15_10_1_T_PK" ON "UR_TEST_CP_15_10_1_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_HOTEL_PRICE_OVERRIDE_CON" ON "UR_HOTEL_PRICE_OVERRIDE" ("HOTEL_ID", "STAY_DATE", "TYPE") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_16_OCT_CP_LOS1_1_T_PK" ON "UR_16_OCT_CP_LOS1_1_T" ("REC_ID") 
  ;

  CREATE UNIQUE INDEX "UR_TMPLT_NEW_CP_17_OCT_2_T_STAY_DATE_UQ" ON "UR_TMPLT_NEW_CP_17_OCT_2_T" ("STAY_DATE") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_TMPLT_NEW_CP_17_OCT_1_T_STAY_DATE_UQ" ON "UR_TMPLT_NEW_CP_17_OCT_1_T" ("STAY_DATE") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_TEST_CP_15_10_T_PK" ON "UR_TEST_CP_15_10_T" ("REC_ID") 
  ;

  CREATE UNIQUE INDEX "UR_VK_ATT_QUAL1_T_RNS__OTB__UQ" ON "UR_VK_ATT_QUAL1_T" ("RNS__OTB_") 
  ;

  CREATE UNIQUE INDEX "UR_16_OCT_CP_28_D1_T_STAY_DATE_UQ" ON "UR_16_OCT_CP_28_D1_T" ("STAY_DATE") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_TMPLT_NEW_CP_17_OCT_2_T_PK" ON "UR_TMPLT_NEW_CP_17_OCT_2_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_UR_EVENTS_UP_T_PK" ON "UR_UR_EVENTS_UP_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_16_OCT_CP_14_D1_T_PK" ON "UR_16_OCT_CP_14_D1_T" ("REC_ID") 
  ;

  CREATE UNIQUE INDEX "UR_16_OCT_CP_14_D2_T_PK" ON "UR_16_OCT_CP_14_D2_T" ("REC_ID") 
  ;

  CREATE UNIQUE INDEX "UR_16_OCT_CP_14_D2_T_STAY_DATE_UQ" ON "UR_16_OCT_CP_14_D2_T" ("STAY_DATE") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_CHG_CROWBOROUGH_ARMS_BETA_T_BOOKING_DATE_UQ" ON "UR_CHG_CROWBOROUGH_ARMS_BETA_T" ("BOOKING_DATE") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_UR_OY_T_PK" ON "UR_UR_OY_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_TMPLT_NEW_CP_17_OCT_T_STAY_DATE_UQ" ON "UR_TMPLT_NEW_CP_17_OCT_T" ("STAY_DATE") 
  ;

  CREATE UNIQUE INDEX "UR_CHG_CROWBOROUGH_ARMS_BETA_T_PK" ON "UR_CHG_CROWBOROUGH_ARMS_BETA_T" ("REC_ID") 
  ;

  CREATE UNIQUE INDEX "UR_EXPENSE_TEMPLATE_02_T_PK" ON "UR_EXPENSE_TEMPLATE_02_T" ("ROW_ID") 
  ;

  CREATE UNIQUE INDEX "UR_TEST_CP_15_10_1_T_STAY_DATE2_UQ" ON "UR_TEST_CP_15_10_1_T" ("STAY_DATE2") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_16_OCT_CP_LOS1_2_T_PK" ON "UR_16_OCT_CP_LOS1_2_T" ("REC_ID") 
  ;

  CREATE UNIQUE INDEX "UR_CHG_CROWBOROUGH_ARMS_T_PK" ON "UR_CHG_CROWBOROUGH_ARMS_T" ("REC_ID") 
  ;

  CREATE UNIQUE INDEX "UR_TMPLT_NEW_CP_17_OCT_1_T_PK" ON "UR_TMPLT_NEW_CP_17_OCT_1_T" ("REC_ID") 
  ;
  ...
  CREATE UNIQUE INDEX "UR_TMPLT_NEW_CP_17_OCT_T_PK" ON "UR_TMPLT_NEW_CP_17_OCT_T" ("REC_ID") 
  ;
...
create or replace FUNCTION FN_CLEAN_NUMBER (p_value IN VARCHAR2)
   RETURN NUMBER
IS
   l_clean VARCHAR2(1000);
   l_num   NUMBER;
BEGIN
   ...
   l_clean := TRIM(REGEXP_REPLACE(p_value, '[£$€₹,% ]', ''));

   -- Check if it's numeric after cleaning
   IF REGEXP_LIKE(l_clean, '^-?\d+(\.\d+)?$') THEN
      RETURN TO_NUMBER(l_clean);
   ELSE
      RETURN NULL;
   END IF;
EXCEPTION
...
END trg_ur_users_bi_trg;
/
create or replace TRIGGER "UR_16_OCT_CP_14_D1_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_14_D1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_16_OCT_CP_14_D1_T_BI_TRG;
/
create or replace TRIGGER "UR_16_OCT_CP_14_D2_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_14_D2_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_16_OCT_CP_14_D2_T_BI_TRG;
/
create or replace TRIGGER "UR_16_OCT_CP_28_D1_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_28_D1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_16_OCT_CP_28_D1_T_BI_TRG;
/
create or replace TRIGGER "UR_16_OCT_CP_28_D2_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_28_D2_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_16_OCT_CP_28_D2_T_BI_TRG;
/
create or replace TRIGGER "UR_16_OCT_CP_7_D1_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_7_D1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_16_OCT_CP_7_D1_T_BI_TRG;
/
create or replace TRIGGER "UR_16_OCT_CP_LOS1_1_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_LOS1_1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_16_OCT_CP_LOS1_1_T_BI_TRG;
/
create or replace TRIGGER "UR_16_OCT_CP_LOS1_2_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_LOS1_2_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_16_OCT_CP_LOS1_2_T_BI_TRG;
/
create or replace TRIGGER "UR_16_OCT_CP_LOS_1_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_16_OCT_CP_LOS_1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_ADAM_T_BI_TRG;
/
create or replace TRIGGER "UR_APS1_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_APS1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_BHAUMIK_T_BI_TRG;
/
create or replace TRIGGER "UR_CHG_CROWBOROUGH_ARMS_BETA_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_CHG_CROWBOROUGH_ARMS_BETA_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_CHG_CROWBOROUGH_ARMS_BETA_T_BI_TRG;
/
create or replace TRIGGER "UR_CHG_CROWBOROUGH_ARMS_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_CHG_CROWBOROUGH_ARMS_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_TEST_13_10_CP_T_BI_TRG;
/
create or replace TRIGGER "UR_TEST_16_OCT_CP_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_TEST_16_OCT_CP_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_TEST_CHINAR_T_BI_TRG;
/
create or replace TRIGGER "UR_TEST_CP_15_10_1_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_TEST_CP_15_10_1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_TEST_CP_15_10_1_T_BI_TRG;
/
create or replace TRIGGER "UR_TEST_CP_15_10_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_TEST_CP_15_10_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_TEST_STACY_T_BI_TRG;
/
create or replace TRIGGER "UR_TEST_TEMPLATE_1_CP_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_TEST_TEMPLATE_1_CP_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_TEST_TEMPLATE_T_BI_TRG;
/
create or replace TRIGGER "UR_TMPLT_NEW_CP_17_OCT_1_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_TMPLT_NEW_CP_17_OCT_1_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_TMPLT_NEW_CP_17_OCT_1_T_BI_TRG;
/
create or replace TRIGGER "UR_TMPLT_NEW_CP_17_OCT_2_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_TMPLT_NEW_CP_17_OCT_2_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_TMPLT_NEW_CP_17_OCT_2_T_BI_TRG;
/
create or replace TRIGGER "UR_TMPLT_NEW_CP_17_OCT_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_TMPLT_NEW_CP_17_OCT_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_TT_T_BI_TRG;
/
create or replace TRIGGER "UR_UR_19_POINT_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_UR_19_POINT_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_UR_CHINAR_QUAL_T_BI_TRG;
/
create or replace TRIGGER "UR_UR_EVENTS_UP_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_UR_EVENTS_UP_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_UR_EVENTS_UP_T_BI_TRG;
/
create or replace TRIGGER "UR_UR_OY_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_UR_OY_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_UR_OY_T_BI_TRG;
/
create or replace TRIGGER "UR_UR_STR_FOUR_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_UR_STR_FOUR_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
END UR_UR_STR_FOUR_T_BI_TRG;
/
create or replace TRIGGER "UR_UR_STR_SEC_T_BI_TRG"
BEFORE INSERT OR UPDATE ON "UR_UR_STR_SEC_T"
FOR EACH ROW
DECLARE
  v_user_id UR_USERS.USER_ID%TYPE;
...
BEGIN
    -- 1️⃣ Get new JSON from collection
    ...
    -- 3️⃣ Fetch current template details
    BEGIN
    ...
    -- 4️⃣ Check if BD object has existing data
    ...
    ELSE
        ...
        ELSE
            -- Definition different and no data → proceed with update
            UPDATE ur_templates
            ...
            -- 6️⃣ If update mode is ON, recreate the DB object
            ...
            -- 7️⃣ Optional: create ranking view if RST type
...
/
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEMP_CROWBOROUGHARMS_REPORT1_V" ("HOTELID", "BOOKING_DATE - CHG - Crowborough Arms - BETA", "DIRECT - CHG - Crowborough Arms - BETA", "NUM_PEOPLE - CHG - Crowborough Arms - BETA", "COST - CHG - Crowborough Arms - BETA", "PACKAGE_DEAL - CHG - Crowborough Arms - BETA") AS 
  WITH t1_rn AS (
  SELECT hotel_id, BOOKING_DATE, DIRECT, NUM_PEOPLE, COST, PACKAGE_DEAL, BOOKING_DATE as pk_col,
         ROW_NUMBER() OVER (PARTITION BY hotel_id ORDER BY BOOKING_DATE) rn
  FROM UR_CHG_CROWBOROUGH_ARMS_BETA_T
  WHERE hotel_id = '411F6025A0800F62E063265A000A9D66'
)
SELECT COALESCE(t1_rn.hotel_id, null) AS hotelid,
       t1_rn.BOOKING_DATE AS "BOOKING_DATE - CHG - Crowborough Arms - BETA",
       t1_rn.DIRECT AS "DIRECT - CHG - Crowborough Arms - BETA",
       t1_rn.NUM_PEOPLE AS "NUM_PEOPLE - CHG - Crowborough Arms - BETA",
       t1_rn.COST AS "COST - CHG - Crowborough Arms - BETA",
       t1_rn.PACKAGE_DEAL AS "PACKAGE_DEAL - CHG - Crowborough Arms - BETA"
FROM t1_rn

ORDER BY COALESCE(t1_rn.rn, 0)  ;

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEMP_CROWBOROUGHARMS_REPORT2_V" ("HOTELID", "BOOKING_DATE - CHG - Crowborough Arms - BETA", "NUM_PEOPLE - CHG - Crowborough Arms - BETA", "COST - CHG - Crowborough Arms - BETA", "PACKAGE_DEAL - CHG - Crowborough Arms - BETA", "DIRECT - CHG - Crowborough Arms - BETA", "PCW - CHG - Crowborough Arms - BETA", "REPEAT_BOOKER - CHG - Crowborough Arms - BETA", "BOOKER_NAME - CHG - Crowborough Arms - BETA", "BOOKER_REF - CHG - Crowborough Arms - BETA") AS 
  WITH t1_rn AS (
  SELECT hotel_id, BOOKING_DATE, NUM_PEOPLE, COST, PACKAGE_DEAL, DIRECT, PCW, REPEAT_BOOKER, BOOKER_NAME, BOOKER_REF, BOOKING_DATE as pk_col,
         ROW_NUMBER() OVER (PARTITION BY hotel_id ORDER BY BOOKING_DATE) rn
  FROM UR_CHG_CROWBOROUGH_ARMS_BETA_T
  WHERE hotel_id = '411F6025A0800F62E063265A000A9D66'
)
SELECT COALESCE(t1_rn.hotel_id, null) AS hotelid,
       ...
       t1_rn.PACKAGE_DEAL AS "PACKAGE_DEAL - CHG - Crowborough Arms - BETA",
       t1_rn.DIRECT AS "DIRECT - CHG - Crowborough Arms - BETA",
       t1_rn.PCW AS "PCW - CHG - Crowborough Arms - BETA",
       t1_rn.REPEAT_BOOKER AS "REPEAT_BOOKER - CHG - Crowborough Arms - BETA",
       t1_rn.BOOKER_NAME AS "BOOKER_NAME - CHG - Crowborough Arms - BETA",
       t1_rn.BOOKER_REF AS "BOOKER_REF - CHG - Crowborough Arms - BETA"
FROM t1_rn

ORDER BY COALESCE(t1_rn.rn, 0)  ;

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEMP_INDIGOHOTELS_INDIGOREPORT_V" ("HOTELID", "BOOKING_ID - VK Sample Hotel Data", "BOOKING_DATE - VK Sample Hotel Data", "STAY_DATE - VK Sample Hotel Data", "OCCUPANCY__ - VK Sample Hotel Data", "ADR__USD_ - VK Sample Hotel Data", "NUMBER_OF_ROOMS - VK Sample Hotel Data", "BOOKING_CHANNEL - VK Sample Hotel Data", "GUEST_COUNTRY - VK Sample Hotel Data", "REVENUE - VK Sample Hotel Data", "BOOKING_ID - test template", "BOOKING_DATE - test template", "STAY_DATE - test template", "OCCUPANCY__ - test template", "ADR__USD_ - test template", "NUMBER_OF_ROOMS - test template", "BOOKING_CHANNEL - test template", "GUEST_COUNTRY - test template", "REVENUE - test template") AS 
  WITH t1_rn AS (
...
ORDER BY COALESCE(t1_rn.rn, t2_rn.rn,0)  ;
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEMP_INDIGOHOTELS_R2_V" ("HOTELID", "BOOKING_ID - VK Sample Hotel Data", "BOOKING_DATE - VK Sample Hotel Data", "NUMBER_OF_ROOMS - VK Sample Hotel Data", "BOOKING_ID - test template", "BOOKING_DATE - test template", "NUMBER_OF_ROOMS - test template") AS 
  WITH t1_rn AS (
...
ORDER BY COALESCE(t1_rn.rn, t2_rn.rn,0)  ;
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEMP_INDIGOHOTELS_REPORT24_V" ("HOTELID", "NUMBER_OF_ROOMS - VK Sample Hotel Data", "BOOKING_ID - VK Sample Hotel Data", "GUEST_COUNTRY - VK Sample Hotel Data", "BOOKING_DATE - VK Sample Hotel Data", "BOOKING_ID - test template", "OCCUPANCY__ - test template", "ADR__USD_ - test template", "NUMBER_OF_ROOMS - test template") AS 
  WITH t1_rn AS (
...
ORDER BY COALESCE(t1_rn.rn,0)  ;
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEMP_INDIGO_HOTELS_R2_V" ("HOTELID", "T1_RN_BOOKING_ID", "T1_RN_BOOKING_DATE", "T1_RN_NUMBER_OF_ROOMS", "T1_RN_GUEST_COUNTRY", "T1_RN_REVENUE", "T2_RN_BOOKING_ID", "T2_RN_BOOKING_DATE", "T2_RN_NUMBER_OF_ROOMS") AS 
  WITH t1_rn AS (
...
ORDER BY COALESCE(t1_rn.rn,0)  ;
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEMP_MARRIOTCL_TEST_V" ("HOTELID", "SDATE - MCL LoS1", "DAY - MCL LoS1", "MY_OTB - MCL LoS1", "MARKET_DEMAND - MCL LoS1", "DELTA_HOTELS_BY_MARRIOTT_YORK - MCL LoS1", "HILTON_YORK - MCL LoS1", "HOLIDAY_INN_YORK_AN_IHG_HOTEL - MCL LoS1", "RADISSON_HOTEL_YORK - MCL LoS1", "VK_Price_1 - Strategy_Column") AS 
  WITH t1_rn AS (
...
ORDER BY COALESCE(t1_rn.rn,0)  ;
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEMP_YORKHOTEL_YORK06_V" ("HOTELID", "STAY_DATE - York_temp14", "DAY - York_temp14", "MY_OTB - York_temp14", "MARKET_DEMAND - York_temp14", "HILTON_YORK - York_temp14", "RADISSON_HOTEL_YORK - York_temp14", "NOVOTEL_YORK_CENTRE - York_temp14", "MOXY_YORK - York_temp14", "HOTEL_INDIGO_YORK_AN_IHG_HOTEL - York_temp14", "HAMPTON_BY_HILTON_YORK - York_temp14") AS 
  WITH t1_rn AS (
...
ORDER BY COALESCE(t1_rn.rn, s1_rn.rn, 0)  ;
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEMP_YORKHOTEL_YORK8_V" ("HOTELID", "STAY_DATE - York_temp14", "MY_OTB - York_temp14", "MARKET_DEMAND - York_temp14", "HAMPTON_BY_HILTON_YORK - York_temp14", "DAY - York_temp12") AS 
  WITH t1_rn AS (
  SELECT hotel_id, STAY_DATE, MY_OTB, MARKET_DEMAND, HAMPTON_BY_HILTON_YORK, STAY_DATE as pk_col,
         ROW_NUMBER() OVER (PARTITION BY hotel_id ORDER BY STAY_DATE) rn
  FROM UR_YORK_TEMP14_T
  WHERE hotel_id = '3F89FD08835C25B3E063265A000A5EED'
),
t2_rn AS (
  SELECT hotel_id, DAY, STAY_DATE as pk_col,
         ROW_NUMBER() OVER (PARTITION BY hotel_id ORDER BY DAY) rn
  FROM UR_YORK_TEMP12_T
  WHERE hotel_id = '3F89FD08835C25B3E063265A000A5EED'
)
SELECT COALESCE(t1_rn.hotel_id, t2_rn.hotel_id, null) AS hotelid,
       t1_rn.STAY_DATE AS "STAY_DATE - York_temp14",
       ...
       t1_rn.MARKET_DEMAND AS "MARKET_DEMAND - York_temp14",
       t1_rn.HAMPTON_BY_HILTON_YORK AS "HAMPTON_BY_HILTON_YORK - York_temp14",
       t2_rn.DAY AS "DAY - York_temp12"
FROM t1_rn
FULL OUTER JOIN t2_rn
      ON t1_rn.hotel_id = t2_rn.hotel_id
     AND t1_rn.pk_col = t2_rn.pk_col
ORDER BY COALESCE(t1_rn.rn, t2_rn.rn, 0)  ;
...
ORDER BY COALESCE(t1_rn.rn,0)  ;
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "TEMP_YORKHOTEL_YORK_REPORT_V" ("HOTELID", "RADISSON_HOTEL_YORK - York_temp14", "NOVOTEL_YORK_CENTRE - York_temp14", "MOXY_YORK - York_temp14", "STAY_DATE - York_temp14", "HAMPTON_BY_HILTON_YORK - York_temp14", "ELMBANK_YORK_TAPESTRY_COLLECTION_BY_HILTON - York_temp14", "MARKET_DEMAND - York_temp14", "HILTON_YORK - York_temp14", "DOUBLETREE_BY_HILTON_YORK - York_temp14") AS 
  WITH t1_rn AS (
...
ORDER BY COALESCE(t1_rn.rn, 0)  ;
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_DEMO_30SEP25_RANKING_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE", "RANK_9_NAME", "RANK_9_RATE", "RANK_10_NAME", "RANK_10_RATE", "RANK_11_NAME", "RANK_11_RATE") AS 
  WITH all_properties_ranked AS (
    ...
    UNPIVOT (price FOR hotel_name IN ("DELTA_HOTELS_BY_MARRIOTT_YORK", "DOUBLETREE_BY_HILTON_YORK", "ELMBANK_YORK_TAPESTRY_COLLECTION_BY_HILTON", "HAMPTON_BY_HILTON_YORK", "HILTON_YORK", "HOLIDAY_INN_YORK_AN_IHG_HOTEL", "HOTEL_INDIGO_YORK_AN_IHG_HOTEL", "MOXY_YORK", "NOVOTEL_YORK_CENTRE", "RADISSON_HOTEL_YORK", "THE_MILNER_YORK_FORMERLY_THE_PRINCIPAL_YORK"))
)
SELECT 
...
JOIN (
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_LOS1_INDIGO_RANKING_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE", "RANK_9_NAME", "RANK_9_RATE", "RANK_10_NAME", "RANK_10_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "STAY_DATE",
        hotel_name,
    ...
    FROM "UR_LOS1_INDIGO_T"
    UNPIVOT (price FOR hotel_name IN ("DELTA_HOTELS_BY_MARRIOTT_YORK", "DOUBLETREE_BY_HILTON_YORK", "ELMBANK_YORK_TAPESTRY_COLLECTION_BY_HILTON", "HAMPTON_BY_HILTON_YORK", "HILTON_YORK", "HOLIDAY_INN_YORK_AN_IHG_HOTEL", "HOTEL_INDIGO_YORK_AN_IHG_HOTEL", "MOXY_YORK", "NOVOTEL_YORK_CENTRE", "RADISSON_HOTEL_YORK"))
)
SELECT 
...
JOIN (
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_LOS1_MCL_RANKING_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE", "RANK_9_NAME", "RANK_9_RATE", "RANK_10_NAME", "RANK_10_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "STAY_DATE",
        hotel_name,
...
JOIN (
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_LOS1_YORK_12_RANKING_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE", "RANK_9_NAME", "RANK_9_RATE", "RANK_10_NAME", "RANK_10_RATE", "RANK_11_NAME", "RANK_11_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "SDATE",
        hotel_name,
...
JOIN (
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_LOS1_YORK_13OCT_RANKING_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE", "RANK_9_NAME", "RANK_9_RATE", "RANK_10_NAME", "RANK_10_RATE", "RANK_11_NAME", "RANK_11_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "SDATE",
        hotel_name,
...
JOIN (
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_LOS1_YORK_13_RANKING_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE", "RANK_9_NAME", "RANK_9_RATE", "RANK_10_NAME", "RANK_10_RATE", "RANK_11_NAME", "RANK_11_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "SDATE",
        hotel_name,
...
JOIN (
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_LOS1_YORK_2_RANKING_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE", "RANK_9_NAME", "RANK_9_RATE", "RANK_10_NAME", "RANK_10_RATE", "RANK_11_NAME", "RANK_11_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "SDATE",
        hotel_name,
...
JOIN (
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_MCL_LOS1_RANKING_V" ("STAY_DATE", "HOTEL_ID", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE", "RANK_9_NAME", "RANK_9_RATE", "RANK_10_NAME", "RANK_10_RATE", "RANK_11_NAME", "RANK_11_RATE") AS 
  WITH all_properties_ranked AS (
  SELECT
    "SDATE",
    hotel_id, -- <<< ADDED
...
FROM
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_TMPLTNEW_CP_17_OCT_2_RANK_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "STAY_DATE",
        hotel_name,
        CASE WHEN REGEXP_LIKE(price, '^[0-9,.]+$') THEN TO_NUMBER(REPLACE(price, ',', '')) ELSE NULL END AS price,
        ROW_NUMBER() OVER(PARTITION BY "STAY_DATE" ORDER BY CASE WHEN REGEXP_LIKE(price, '^[0-9,.]+$') THEN TO_NUMBER(REPLACE(price, ',', '')) ELSE NULL END ASC NULLS LAST) as overall_rank
    FROM "UR_TMPLT_NEW_CP_17_OCT_2_T"
    UNPIVOT (price FOR hotel_name IN ("TODAY_GROUPS"))
)
SELECT 
    p."STAY_DATE" AS "STAY_DATE",
    own.price AS "OWN_PROPERTY_RATE",
...
FROM (
    SELECT "STAY_DATE", MAX(CASE WHEN overall_rank = 1 THEN hotel_name END) AS "RANK_1_NAME",
MAX(CASE WHEN overall_rank = 1 THEN price END) AS "RANK_1_RATE" FROM all_properties_ranked GROUP BY "STAY_DATE"
) p
JOIN (
    SELECT "STAY_DATE", price, overall_rank FROM all_properties_ranked WHERE hotel_name = 'TODAY_GROUPS'
) own ON p."STAY_DATE" = own."STAY_DATE";

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_VK_LOS1_YORK_2_RANKING_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE", "RANK_9_NAME", "RANK_9_RATE", "RANK_10_NAME", "RANK_10_RATE", "RANK_11_NAME", "RANK_11_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "SDATE",
        hotel_name,
...
JOIN (
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_VK_LOS1_YORK_3_RANKING_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE", "RANK_9_NAME", "RANK_9_RATE", "RANK_10_NAME", "RANK_10_RATE", "RANK_11_NAME", "RANK_11_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "SDATE",
        hotel_name,
...
JOIN (
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_VK_LOS1_YORK_4_RANKING_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "SDATE",
        hotel_name,
    ...
    UNPIVOT (price FOR hotel_name IN ("DELTA_HOTELS_BY_MARRIOTT_YORK", "DOUBLETREE_BY_HILTON_YORK", "HILTON_YORK", "HOLIDAY_INN_YORK_AN_IHG_HOTEL", "MOXY_YORK", "NOVOTEL_YORK_CENTRE", "RADISSON_HOTEL_YORK", "THE_MILNER_YORK_FORMERLY_THE_PRINCIPAL_YORK"))
)
SELECT 
    p."SDATE" AS "STAY_DATE",
    own.price AS "OWN_PROPERTY_RATE",
...
JOIN (
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UR_VK_LOS1_YORK_RANKING_V" ("STAY_DATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "RANK_1_NAME", "RANK_1_RATE", "RANK_2_NAME", "RANK_2_RATE", "RANK_3_NAME", "RANK_3_RATE", "RANK_4_NAME", "RANK_4_RATE", "RANK_5_NAME", "RANK_5_RATE", "RANK_6_NAME", "RANK_6_RATE", "RANK_7_NAME", "RANK_7_RATE", "RANK_8_NAME", "RANK_8_RATE", "RANK_9_NAME", "RANK_9_RATE", "RANK_10_NAME", "RANK_10_RATE", "RANK_11_NAME", "RANK_11_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "SDATE",
        hotel_name,
...
JOIN (
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_RANKING_UR_LOS1_YORK_2_T" ("SDATE", "OWN_PROPERTY_RATE", "OWN_PROPERTY_RANK", "COMP_RANK_1_RATE", "COMP_RANK_2_RATE", "COMP_RANK_3_RATE", "COMP_RANK_4_RATE", "COMP_RANK_5_RATE", "COMP_RANK_6_RATE", "COMP_RANK_7_RATE", "COMP_RANK_8_RATE", "COMP_RANK_9_RATE", "COMP_RANK_10_RATE") AS 
  WITH all_properties_ranked AS (
    SELECT 
        "SDATE",
        hotel_name,
